package com.workshop.SpringBoot.resources.exception;
...
public class ResourceExceptionHandler {
    ...
    public ResponseEntity<StandardError> objectBNotFound(ObjectNotFoundException e, HttpServletRequest request){
